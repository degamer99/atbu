  ...
  return (
    <>
     ...
     crossorigin="anonymous" />
      ...
      <main>
        <section className={styles.fav} onClick={ () => setUploadState( x => !x)} >
        ...
        <section className={styles.form}>
          ...
          <input type="button" value={uploadState? "Uploading..." : "Upload"} className={uploadState? styles.buttonLoad : styles.buttonB} onClick={uploadChange}/>
        </section>
        <p>
