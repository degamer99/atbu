...
import { upload, download, add, read} from '../../lib/firebase'
...
export default function Home({isConnected, data}) {
  ...
  return (
    <>
      ...
      <main>
        <section className={styles.fav} onClick={ () => read()} >
        ...
        <section className={styles.form}>
          ...
          <input type="button" value="Download" className={styles.button} onClick={() => downloadRef.current.click()}/>
          <a href="https://www.google.com" ref={downloadRef} hidden > go somewhere</a>
          <div>
            <span className='styles.splice'>or</span>
          </div>
          <input type="button" value="Upload" className={styles.button} onClick={ () => fileRef.current.click()}/>
        </section>
        <p>
